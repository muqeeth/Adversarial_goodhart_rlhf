    ...
    def __init__(
        ...
        if args.num_sample_generations > 0:
            self.sample_generations_freq = max(
                1, args.num_updates // args.num_sample_generations
            )
    ...
    def train(self):
        ...
        for update in range(1, args.num_updates + 1):
            ...
            with torch.no_grad():
                ...
                with unwrap_model_for_generation(
                    ...
                    for i in range(
                        ...
                        ref_output = forward(
                            ref_policy, query_response, tokenizer.pad_token_id
                        )
                ...
                for mini_batch_start in range(
                    ...
                    for micro_batch_start in range(
                        ...
                        with accelerator.accumulate(model):
                            ...
                            output = forward(
                                model, mb_query_responses, tokenizer.pad_token_id
                            )
            ...
            with torch.no_grad():
                ...
                self.state.epoch = (
                    global_step / self.train_dataset_len
                )  # used by self.log
                self.log(metrics)
    ...
    def generate_completions(self, sampling: bool = False):
        ...
        for batch in self.eval_dataloader:
            ...
            with torch.no_grad():
                ...
                table["query"].extend(
                    gather_object(
                        tokenizer.batch_decode(query, skip_special_tokens=True)
                    )
                )
